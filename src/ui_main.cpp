...
{
    Serial.println("Creating modern tileview UI with weather subpage...");
    ...
    lv_obj_t *tile3 = lv_tileview_add_tile(s_ui.tileview, 2, 0, LV_DIR_LEFT | LV_DIR_BOTTOM);
    ...
    lv_label_set_text(hint3, "Swipe >  |  Swipe up");
